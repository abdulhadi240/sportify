...
const Choose = () => {
  return (
    ...
    <div className='flex flex-col gap-4'>
        <div className="text-xs font-bold uppercase tag text-primary">Why choose us?</div>
        ...
        <button className="h-auto py-2 mt-4 text-sm text-white rounded-full w-36 bg-primary">Learn more</button>
