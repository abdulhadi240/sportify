...
const CourtCard = ({image , tag , title , price}) => {
  return (
    <div className='w-64 h-auto p-2 bg-white shadow-xl rounded-xl border-[1px] group transition-all hover:border-primary1  '>
        <div className="image">
        ...
        <div className="flex flex-col gap-3 px-2 pb-3 text">
            ...
            <h4 className='text-xs font-bold text-primary1'>{price}</h4>
            </div>
            <button className="w-24 h-auto py-1 text-xs text-white rounded-full bg-primary1 hover:bg-primary1/80">Book Now</button>
        </div>
    </div>
  )
}
